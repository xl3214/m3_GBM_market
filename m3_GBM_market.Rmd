...
Eastern Cooperative Oncology Group (ECOG) Performance Status is a scale used to assess the functional status of cancer patients, with lower values indicating better functional status and higher values indicating worse functional status. Table below shows ECOG categories and their percentages. 
